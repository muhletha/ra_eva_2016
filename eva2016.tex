...
In the paper presented at the WiMob 2016 conference, we apply these prediction methods to caching.
...
\begin{itemize}
    ...
    \item PhD in progress:
        \begin{itemize}
            \item Nesrine Ben  Hassine ``Learning algorithms for network resource management'', UVSQ, Sept 2017 (expected). 
             \item Younes Bouchaala   ``Handling Safety Messages in Vehicular Ad Hoc Networks (VANETs)'', UVSQ, Sept 2017 (expected). 
