...
\subsubsection{TRPM:  aTDMA-aware routing protocol for multi-hop communications in VANETs}
...
Location-based routing protocols for Vehicular Adhoc
Networks (VANETs) use location information in routing
decisions. These are provided by a location service queried by
nodes to properly forward packets to communication partners.
This paper presents the Partial-Flooding Location Service, a proactive
...
with the physical principles of the protocol. The stabillity (ergodicity) conditions are obtained and
...
\begin{itemize}
    ...
    \item Nadjib Achir
        \begin{enumerate}
            ...
            \item TPC Member International Conference On Network of the Future, NoF 2015.          
        \end{enumerate}
    \item Selma Boumerdassi
        \begin{enumerate}      		
            \item TPC Member IEEE Global Telecommunications Conference, GLOBECOM 2015;
